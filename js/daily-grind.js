/*
    ...
    pick - for example bubble-tea. jpg
...
function coffeeTemplate(coffee){
    ...
    <strong class="feature">${coffee.day}'s Coffee Special:</strong>${coffee.day}'s daily coffee special is <strong class="feature">${coffee.name}</strong>, ${coffee.desc}, as this one of our top sellers!</p>`;
}
